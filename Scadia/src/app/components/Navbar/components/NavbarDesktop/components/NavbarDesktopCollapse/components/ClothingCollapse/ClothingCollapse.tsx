...
export default function ClothingCollapse() {
  ...
  return (
    ...
    >
      <div
        className={`py-5 flex text-lg justify-between w-10/12 3xl:w-7/12 mx-auto`}
      >
        ...
        <div className="flex gap-10">
          <Card
            title="Pants"
            alt="People hiking with professional pants."
            description="For all kinds of terrain."
            src={imagePants}
          />
          <Card
            title="T-Shirts"
            alt="A man hiking with an orange shirt."
            description="Enjoy the simplicity of nature."
            src={imageTshirt}
          />
          <Card
            title="Jackets"
            alt="A couple wearing a warm jacket."
            description="Warm and dry in the winter."
            src={imageJacket}
          />
        </div>
      </div>
