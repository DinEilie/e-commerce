    ...
    >
      ...
      >
        ...
        <div className="flex gap-10">
          <Card
            title="Traveling"
            alt="A close up image of hiking shoes."
            description="Walk as long as ever."
            src={imageShoes}
          />
          <Card
            title="Snow"
            alt="Walking with huge snow boots."
            description="Best equipment during the cold days."
            src={imageWinter}
          />
          <Card
            title="Style"
            alt="A guy with a groovy shoes."
            description="Walk awesome on the street."
            src={imageUrban}
          />
        </div>
      </div>
